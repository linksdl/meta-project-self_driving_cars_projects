...
# results_fullpath += "/resnet/"
# configs_det = det.load_configs(model_name="fpn_resnet")
model_det = det.create_model(configs_det)

# True = use ground truth labels as objects, False = use model-based detection
...
exec_data = ['pcl_from_range_image', 'load_image']
# 目标检测
...
# 'show_tracks', 'show_detection_performance', 'make_tracking_movie'
...
while True:
    try:
        ...
        # 从Range 图片到点云
        if 'pcl_from_range_image' in exec_list:
        ...
        #         if configs_det.lim_x[0] < detection[1] < configs_det.lim_x[1] and configs_det.lim_y[0] < detection[2] < \
        #                 configs_det.lim_y[1]:
