...
%speed of light = 3e8
%% User Defined Range and Velocity of target 2, 目标的初始范围和速度
% *%TODO* :
% define the target's initial position and velocity. Note : Velocity
% remains contant
target_start_position = 60; %target range =100m 范围不能超过最大值 200m
target_velocity = -50;      %target doppler velocity = -20m/s  速度可以是 -70 到 + 70 m/s 范围内的任何值。


%% FMCW Waveform Generation 1，FMCW设置
% *%TODO* :
